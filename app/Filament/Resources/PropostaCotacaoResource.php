...
use App\Filament\Resources\PropostaCotacaoResource\Pages;
use App\Filament\Resources\PropostaCotacaoResource\RelationManagers;
...
class PropostaCotacaoResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('cotacao_id')
                    ->required()
                    ->numeric(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('cotacao_id')
                    ->numeric()
                    ->sortable(),
    ...
    {
        return [
            'index' => Pages\ManagePropostaCotacaos::route('/'),
        ];
    }
}
